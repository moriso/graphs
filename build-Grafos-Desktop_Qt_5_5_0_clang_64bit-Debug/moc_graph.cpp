...
QT_MOC_LITERAL(3, 14, 6) // "Graph*"

    },
    "Graph\0update\0\0Graph*"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Graph::*_t)(Graph * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Graph::update)) {
                *result = 0;
            }
        }
    }
